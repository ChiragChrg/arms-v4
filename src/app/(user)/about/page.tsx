...
const About = () => {
    return (
        <section className='flex flex-col justify-between gap-4 px-4 py-3 w-full h-full min-h-screen'>
            ...
            <h1 className='text-[1.5em] md:text-[2em] font-medium'>About <span className="text-primary font-bold">ARMS</span></h1>
